...
print ""
print "1. 'locus_list.txt' which is stored in the TEMPLATE folder : e.g. C:\Dropbox\Barcin_Hoyuk\AIS_Barcin_Hoyuk_DB_GIS\TEMPLATE\lists\locus_list.txt " 
print ""
...
output_fld = raw_input ("Path to Output folder which has been specified executing BH_Create_Output_layers_add_locus_field.py : e.g. C:\Dropbox\...\AIS_Barcin_Hoyuk_DB_GIS\OUTPUT\: ")
...
res_mxd = raw_input ("Path + name where to save the output mxd : e.g. c:\Dropbox\...\AIS_Barcin_Hoyuk_DB_GIS\BH_GIS.mxd: (DON'T FORGET .mxd) ")
