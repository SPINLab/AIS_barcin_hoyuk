...
for item in list:
    ...
    textToReplace = (
                '#https://vu-data.irodspoc-sara.surf-hosted.nl//research-barcin-hoyuk//STATIC_DATA//' + item + '//')
    ...
    replacements = {textToSearch2: textToReplace2, textToSearch3: textToReplace3, textToSearch4: textToReplace4,
                    textToSearch5: textToReplace5, textToSearch6: textToReplace6, textToSearch7: textToReplace7,
                    textToSearch8: textToReplace8}
